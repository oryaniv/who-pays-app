...
const questionsM = [
  "האם לדעתך נשים מופלות במקומות העבודה?",
  ...
  "האם היה מקובל עליך שהיא תציע לך נישואין בפומבי?",
  "האם תרגיש בנוח במידה ולבת זוגך ידידות קרובה עם גבר אחר?",
  "האם אתה חושב שגבר צריך להקפיד על מחוות כמו לפתוח דלת, ולהסיע?",
  "רבתם. הגיוני שתמיד אתה תתחיל בסולחה?",
  "האם היית מוכן לוותר על קריירה כדי להתמקד בגידול ילדים?",
  "האם העולם היה מקום טוב יותר לו נשלט על ידי נשים?",
];

const questionsF = [
  "האם תהיי מוכנה לוותר על ילדים לטובת קריירה?",
  "האם תצפי ממנו לקחת ולהחזיר אותך?",
  "תצאי עם גבר נמוך ממך?",
  "האם תעדיפי שיהיו לכם שני חשבונות בנק נפרדים?",
  "האם אישה זקוקה לנישואין כדי להרגיש הגשמה עצמית?",
