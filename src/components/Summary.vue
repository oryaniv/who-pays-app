...
<template>
  <div class="summary-container">
    <pre v-if="sex== 'male' && score > 7">
      ...
      אולי זה גורם לך לעבוד קשה, אבל בשבילך
      זה שווה.
    ...
    <pre v-if="sex === 'male' && score < 3">
      ...
      אתה רוצה אישה חזקה, שלא צריכה עזרה, 
      עצה או הצלה.
      אתה רוצה לשבת שם ולהביט בה בהערצה.
    ...
    <pre v-if="sex === 'female' && score >= 7">
      ...
      לכי על זה, אל תפחדי מדבר,
      היי לנו כמו נווה במדבר.
      כסחי, מלכה.
    </pre>
    <!-- <h2>Summary</h2>
    <p>Sex: {{ sex }}</p>
